...
class RegisterViewModel extends BaseViewModel<BaseNavigator> {
  ...
  void register(String email, String password,String fname,String lname,String username) async {
    try {
      ...
      var user = MyUser(id: result.user?.uid??" ",fname: fname,lname: lname,username: username,email: email);
